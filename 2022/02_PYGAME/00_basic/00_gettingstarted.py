...
platform = pygame.image.load("00images/land.png")
...
bird = pygame.image.load("00images/bird.png")
...
pipe_head2 = pygame.Rect(0,0,1.2*pipe.width, 0.1*pipe.height)
pipe_head2.midbottom = pipe2.midtop
...
def check_bird_point():
	global bird_pass_pipe, pipe, bird_rect, score_label_image, score
...
def check_bird_hit():
	global bird_rect, pipe, life, pipe2, pipe_head2, platform_rect, game_start

	collide_top_edge = bird_rect.y <=0
	collide_pipe = bird_rect.colliderect(pipe) or bird_rect.colliderect(pipe_head) 
	collide_pipe_2 = bird_rect.colliderect(pipe2) or bird_rect.colliderect(pipe_head2)
...
play_button = pygame.image.load("00images/play_button.png")
...
title_label = pygame.font.Font("00_fonts/Birdy Game.ttf", 40)
...
score = 0
score_label = pygame.font.Font("00_fonts/Birdy Game.ttf", 20)
score_label_image = score_label.render(f"SCORE : {score}", True, (255,255,255))
...
game_over = False
game_over_label = pygame.font.Font("00_fonts/Birdy Game.ttf", 40)
...
heart = {
	"image":pygame.transform.scale(pygame.image.load("00images/life.png"), (25,25)),
	"rect": pygame.image.load("00images/life.png").get_rect()
}
...
while True :
	pygame.display.flip() # draw-clear-draw
	...
	pygame.draw.rect(screen, (60,60,60), pipe2)
	pygame.draw.rect(screen, (60,60,60), pipe_head2)
	...
	pygame.time.Clock().tick(25)# 25 frame
